...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { assunto_id: @contato.assunto_id, email: @contato.email, mensagem: @contato.mensagem, nome: @contato.nome, respondida: @contato.respondida }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { assunto_id: @contato.assunto_id, email: @contato.email, mensagem: @contato.mensagem, nome: @contato.nome, respondida: @contato.respondida }
    assert_redirected_to contato_path(assigns(:contato))
  end
