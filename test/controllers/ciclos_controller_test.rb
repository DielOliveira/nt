...
class CiclosControllerTest < ActionController::TestCase
  ...
  test "should create ciclo" do
    assert_difference('Ciclo.count') do
      post :create, ciclo: { nomeciclo: @ciclo.nomeciclo, numerociclo: @ciclo.numerociclo, qtdreentradas: @ciclo.qtdreentradas, valorciclo: @ciclo.valorciclo }
    end
  ...
  test "should update ciclo" do
    patch :update, id: @ciclo, ciclo: { nomeciclo: @ciclo.nomeciclo, numerociclo: @ciclo.numerociclo, qtdreentradas: @ciclo.qtdreentradas, valorciclo: @ciclo.valorciclo }
    assert_redirected_to ciclo_path(assigns(:ciclo))
  end
